...
public class ApproximateSearchStrategy extends TemplateSearchStrategy{
    ...
    public List<Book> makeInitialListOfBooks(SearchDTO searchData){
        ...
        return bookRepository.findByTitleContaining(searchData.getTitle());
    }
    ...
    public boolean checkIfAuthorsMatch(SearchDTO searchData, Book book){
        ...
        for(BookAuthor author : authorList){ if(authorSearchList.contains(author.getName())) { return true; } }
